...
public class Converter {
  ...
  /**
   * Iterate over command line arguments and attempts to convert each to a double
   * and then convert that values (assumed to be in degrees Celsius) to a fahrenheit degrees value)
   *
